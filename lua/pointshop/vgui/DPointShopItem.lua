...
local canbuycolor = Color(39, 174, 96)
local cantbuycolor = Color(192, 57, 43)
local ownedcolor = Color(41, 128, 185)
...
function PANEL:PaintOver()
	...
	surface.DrawOutlinedRect(0, self:	GetTall() - self.InfoHeight, self:GetWide(), self.InfoHeight)
	surface.DrawOutlinedRect(0, 0, self:GetWide(), 300)
